...
class ControllerService(csi_pb2_grpc.ControllerServicer):
    ...
    def CreateVolume(self, request, context):
        ...
        # Store volume metadata in Redis
        volume_data = {
            "id": volume_id,
        ...
        # Create volume directory on all nodes (handled by multicloud fs)
    ...
    def DeleteVolume(self, request, context):
        ...
        # Delete volume metadata from Redis
        self.redis_client.hdel("csi:volumes", volume_id)

        # The actual data deletion is handled by the multicloud filesystem
    ...
    def ControllerPublishVolume(self, request, context):
        ...
        # Track which node has this volume
    ...
    def ControllerUnpublishVolume(self, request, context):
        ...
        # Remove node from volume's published nodes
