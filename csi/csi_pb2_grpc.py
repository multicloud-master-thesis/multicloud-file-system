...
class GroupController(object):
    ...
    @staticmethod
    def GroupControllerGetCapabilities(
        request,
        target,
        options=(),
        channel_credentials=None,
