...
def main():
    ...
    parser.add_argument('--root-dir', default='/var/lib/multicloud/volumes', help='Root directory for volumes')
    parser.add_argument('--mount-point', default='/var/lib/multicloud/mounts', help='Mount point base directory')
